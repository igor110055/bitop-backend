...
return [
    ...
    'bank_account' => [
        ...
        'reject_reasons' => [
            ...
            App\Models\BankAccount::REASON_PHONETIC_NAME_NOT_MATCHED => 'Phonetic account name does not match your KYC information.',
            App\Models\BankAccount::REASON_INVALID_NAME => 'Invalid account name.',
            App\Models\BankAccount::REASON_INVALID_PHONETIC_NAME => 'Invalid phonetic account name.',
            App\Models\BankAccount::REASON_INVALID_BRANCH_NAME => 'Invalid bank branch name.',
            App\Models\BankAccount::REASON_INVALID_BRANCH_PHONETIC_NAME => 'Invalid bank branch phonetic name.',
