...
return [
    ...
    'bank_account' => [
        ...
        'reject_reasons' => [
            ...
            App\Models\BankAccount::REASON_PHONETIC_NAME_NOT_MATCHED => '英文戶名與實名驗證資料不符',
            App\Models\BankAccount::REASON_INVALID_NAME => '無效的戶名',
            App\Models\BankAccount::REASON_INVALID_PHONETIC_NAME => '無效的英文戶名',
            App\Models\BankAccount::REASON_INVALID_BRANCH_NAME => '無效的分行名稱',
            App\Models\BankAccount::REASON_INVALID_BRANCH_PHONETIC_NAME => '無效的英文分行名稱',
