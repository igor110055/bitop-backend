...
class AccountReportRepo extends BaseReportRepo implements \App\Repos\Interfaces\AccountReportRepo
{
    ...
    public function initReport($from, $to)
    {
        ...
        $report['system'] = [
            ...
            'group_id' => null,
            'balance' => null,
            'balance_price' => Dec::create(0), # sum
        ];
