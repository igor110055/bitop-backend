...
class CreateWithdrawalDepositReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('withdrawal_deposit_reports', function (Blueprint $table) {
            ...
            $table->decimal('withdrawal_amount', $coin_precision, $coin_scale)->nullable();
            $table->decimal('withdrawal_price', $currency_precision, $currency_scale)->default(0);
            $table->unsignedInteger('deposit_count')->default(0);
            $table->decimal('deposit_amount', $coin_precision, $coin_scale)->nullable();
            $table->decimal('deposit_price', $currency_precision, $currency_scale)->default(0);
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('withdrawal_deposit_reports');
    }
}
